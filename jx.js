...
<ul class="show">
  ...
  <p style="padding:8px;border-bottom: 1.5px solid #FFC0CB;"></p>
...
<ul class="hidden">
  ...
  <p style="text-decoration:line-through;color: #ccc"><label>107-116期 </label>21,33,27,39<span> (至少1次)</span></p>  <p style="padding:8px;border-bottom: 1.5px solid #FFC0CB;"></p>
  <p style="font-size: 13px;">
【116期】14组150码统计结果：<br>
